...
public class WorkingBean implements Serializable {
	...
	public String save() {
		...
		ERROR_CODE err = TransactionsDAO.setTransactionFromServices(transaction, transactionServices, payBys);
		if( ERROR_CODE.SUCCEED == err) {
			context.addMessage(null, new FacesMessage( FacesMessage.SEVERITY_INFO, "Transaction checkout!", "INFO" ));
			// reload staff list
			return "workingComponent?faces-redirect=true";
		}
		else	{
